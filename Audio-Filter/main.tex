...
\begin{lstlisting}
$https://github.com/Praful-Kesavadas/signals-and-systems/blob/master/Signals%20and%20systems/Audio-Filter/codes/Praful_Singing.wav
\end{lstlisting}
...
There are a lot of yellow lines between 440 Hz to 3KHz.  These represent the synthesizer key tones. Also, the key strokes are audible along with background noise.\\
\begin{figure}[H]
	\centering
    \includegraphics[width=\columnwidth]{figs/Sound_before_filtering.png }
...
\lstinputlisting{codes/2.3.py}\label{prob:audio_filter_problem}
\item
The output of the python script in Problem \ref{prob:audio_filter_problem} is the audio file Sound-with-Reduced-noise.wav. Play the file in the spectrogram in Problem \ref{prob:spectrogram}. What do you observe?
\\
\solution The key strokes as well as background noise is subdued in the audio.  Also,  the signal is blank for frequencies above 3 kHz.
\begin{figure}[H]
	\centering
    \includegraphics[width=\columnwidth]{figs/Sound_after_filtering.png }
...
\begin{lstlisting}
https://github.com/Praful-Kesavadas/signals-and-systems/blob/master/Signals%20and%20systems/Audio-Filter/codes/3.c
\end{lstlisting} 
The following code plots \eqref{prob:2.1} and \eqref{prob:2.2}
\begin{lstlisting}
https://github.com/Praful-Kesavadas/signals-and-systems/blob/master/Signals%20and%20systems/Audio-Filter/codes/3.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Praful-Kesavadas/signals-and-systems/blob/master/Signals%20and%20systems/Audio-Filter/codes/4.5.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Praful-Kesavadas/signals-and-systems/blob/master/Signals%20and%20systems/Audio-Filter/codes/5.2.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Praful-Kesavadas/signals-and-systems/blob/master/Signals%20and%20systems/Audio-Filter/codes/hndef.py
\end{lstlisting}
\begin{figure}[!ht]
\centering
...
%
\begin{lstlisting}
https://github.com/Praful-Kesavadas/signals-and-systems/blob/master/Signals%20and%20systems/Audio-Filter/codes/5.5.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Praful-Kesavadas/signals-and-systems/blob/master/Signals%20and%20systems/Audio-Filter/codes/6.123.py
\end{lstlisting}
\begin{figure}[H]
\centering
\includegraphics[width=\columnwidth]{figs/yn_by_dft.png}
\caption{$y(n)$ obtained from IDFT is plotted }
\label{fig:yn_verf_6.4}
\end{figure}
...
\begin{lstlisting}
https://github.com/Praful-Kesavadas/signals-and-systems/blob/master/Signals%20and%20systems/Audio-Filter/codes/6.4.py
\end{lstlisting}
This code verifies the result by plotting the obtained result with the result obtained by DFT.
\begin{figure}[H]
\centering
\includegraphics[width=\columnwidth]{figs/yn_verf_6.4.png}
...
\begin{lstlisting}
https://github.com/Praful-Kesavadas/signals-and-systems/blob/master/Signals%20and%20systems/Audio-Filter/codes/6.5.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Praful-Kesavadas/signals-and-systems/blob/master/Signals%20and%20systems/Audio-Filter/codes/7.1.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Praful-Kesavadas/signals-and-systems/blob/master/Signals%20and%20systems/Audio-Filter/codes/7.2.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Praful-Kesavadas/signals-and-systems/blob/master/Signals%20and%20systems/Audio-Filter/codes/filter_response.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\\
\solution The given butterworth filter is lowpass with order=4 and cutoff-frequency=3kHz.
